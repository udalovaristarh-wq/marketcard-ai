...
from app.services.next_gen.image_generator_v2 import generate_series_images
...
from app.services.next_gen.design_director_v2 import build_design_direction
from app.services.next_gen.tools.text_quality_checker import check_text_quality
...
def full_generate(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    locked_product_path = product_lock["locked_product_path"]
    ...
    for p_item in prompts:
        p_item["prompt"] = design_direction["master_prompt"] + "\n\n" + str(p_item.get("prompt", ""))
