...
<h1>Privacy Policy</h1>
      ...
      <ul>
        ...
        <li>Usage data (logs, interactions, analytics)</li>
        <li>Content you upload (images, product data)</li>
        <li>Technical data (IP address, device, browser)</li>
      </ul>

      <h2>2. Payments</h2>
      <p>
        We do NOT store or process your bank card details. All payments are handled
        by third-party providers such as Payme, Click, and Visa.
      </p>
      ...
      <p>
        We may use third-party services for hosting, analytics, and payments.
      ...
      <h2>Политика конфиденциальности (RU)</h2>

      <p>
        Настоящая политика описывает, как MarketCard AI собирает, использует и
      ...
      <ul>
        ...
        <li>Данные использования сервиса</li>
        <li>Загружаемый контент</li>
        <li>Технические данные (IP, устройство)</li>
      </ul>

      <h3>2. Платежи</h3>
      <p>
        Мы не храним данные банковских карт. Все платежи проходят через Payme,
        Click, Visa и другие платежные системы.
      </p>

      <h3>3. Использование данных</h3>
      <ul>
        <li>Для работы сервиса</li>
        <li>Для улучшения продукта</li>
        <li>Для поддержки пользователей</li>
        <li>Для безопасности</li>
      </ul>

      <h3>4. Защита данных</h3>
      <p>
        Мы принимаем разумные меры для защиты данных, однако не можем гарантировать
